                ...
                <Grid container display="flex" spacing={4}>
                    <Grid item xs={12} sm={6} >
                        <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} pb={2}>
                            ...
                            {
                                data?.contact_id ?
                                    <Link to={`/dashboard/contact/view/${data?.contact_id?._id}`}>
                    ...
                    <Grid item xs={12} sm={6}>
                        ...
                        <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2} display={"flex"}>
                            <Grid item xs={12} sm={6}>
                                ...
                                <Typography variant="body2" color={Palette.grey[600]} onClick={() => data?.instagramProfile ? handleInsta(data?.instagramProfile) : "--"} style={{ cursor: "pointer", textDecoration: "underline", color: Palette.primary.main }}>
                                    {data?.instagramProfile ? data?.instagramProfile : "--"}
                                </Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"> Twitter Profile :</Typography>
                                <Typography variant="body2" color={Palette.grey[600]} onClick={() => data?.twitterProfile ? handleTwitter(data?.twitterProfile) : "--"} style={{ cursor: "pointer", textDecoration: "underline", color: Palette.primary.main }}>
                        ...
                        <Grid style={{ borderBottom: "1.5px dashed", borderBottomColor: Palette.grey[400] }} py={2} display={"flex"}>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1">Instagram Profile :</Typography>
                                <Typography variant="body2" color={Palette.grey[600]} onClick={() => data?.additionalInstagramProfile ? handleInsta(data?.additionalInstagramProfile) : "--"} style={{ cursor: "pointer", textDecoration: "underline", color: Palette.primary.main }}>
                                    {data?.additionalInstagramProfile ? data?.additionalInstagramProfile : "--"}
                                </Typography>
                            </Grid>
                            <Grid item xs={12} sm={6}>
                                <Typography variant="body1"> Twitter Profile :</Typography>
                                <Typography variant="body2" color={Palette.grey[600]} onClick={() => data?.additionalTwitterProfile ? handleTwitter(data?.additionalTwitterProfile) : "--"} style={{ cursor: "pointer", textDecoration: "underline", color: Palette.primary.main }}>
